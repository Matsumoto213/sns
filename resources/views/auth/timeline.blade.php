<!-- 今までの流れを説明すると、
ユーザーが/timelineにアクセスする  
Auth\TimelineコントローラのshowTimelinePageが呼ばれる(web.php)  
resources/views/auth/timeline.blade.phpを表示する
 -->
...
<html lang="ja" style="height:100%;">
    ...
    <body style="height:100%; background-color: #E6ECF0;">
        <div class="wrapper" style="margin: 0 auto; width: 50%; height: 100%; background-color: white;">
            ...
            <!-- コントローラーの$validatorの部分で引っ掛かったらビューの$errors->first('tweet')で表示します。} -->
            <p style="font-size: 0.7rem; color:red; padding:0.2rem;">
            *$errors->first('tweet')}}</p>
            @endif
            </form>
